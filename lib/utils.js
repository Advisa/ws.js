...
function dateDiffInMin(d1, d2) {
  ...
  return parseInt((d2-d1)/(seconds_in_minute*milliseconds_in_second), 10);
}
...
exports.EMPTY_SOAP = "<soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'><soap:Header /><soap:Body /></soap:Envelope>";
